...
@Controller
public class PlugsApiController implements PlugsApi {

    private static final Logger log = LoggerFactory.getLogger(PlugsApiController.class);
    ...
    public PlugsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
